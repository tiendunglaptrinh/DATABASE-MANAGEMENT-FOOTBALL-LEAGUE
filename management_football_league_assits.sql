...
--
-- Table structure for table `assits`
--

DROP TABLE IF EXISTS `assits`;
...
CREATE TABLE `assits` (
  ...
  KEY `FK_ASSIT_RELATED` (`Assit_Player`,`Assit_Match`,`Assit_HYear`),
...
--
-- Dumping data for table `assits`
--

LOCK TABLES `assits` WRITE;
/*!40000 ALTER TABLE `assits` DISABLE KEYS */;
/*!40000 ALTER TABLE `assits` ENABLE KEYS */;
UNLOCK TABLES;
