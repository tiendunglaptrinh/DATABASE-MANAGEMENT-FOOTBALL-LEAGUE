...
CREATE TABLE `participate_in` (
  ...
  KEY `FK_YEAR_PARTICIPATE` (`P_HYearCode`),
...
INSERT INTO `participate_in` VALUES ('ARG',2022),('BRA',2022),('CHN',2022),('FRA',2022),('GER',2022),('IND',2022),('MEX',2022),('NGA',2022),('RUS',2022),('USA',2022);
